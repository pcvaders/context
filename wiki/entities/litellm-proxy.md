...
Username: `admin`  
Password: _(redacted — local secret; rotated 2026-05-30)_ <!-- secret-scan-ok: redacted, rotated -->
...
curl http://localhost:4000/v1/models \
  -H "Authorization: Bearer $LITELLM_KEY"   # local secret, not stored in wiki
```
